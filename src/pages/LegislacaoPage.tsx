...
const NORMAS: Norma[] = [
  ...
  { categoria: 'Códigos', titulo: 'Código Penal (Decreto-Lei nº 2.848/1940)', descricao: 'Normas de direito penal.', url: 'https://www.planalto.gov.br/ccivil_03/decreto-lei/del2848compilado.htm' },
  ...
  { categoria: 'Códigos', titulo: 'Código de Processo Penal (Decreto-Lei nº 3.689/1941)', descricao: 'Normas do processo penal.', url: 'https://www.planalto.gov.br/ccivil_03/decreto-lei/del3689compilado.htm' },
  { categoria: 'Códigos', titulo: 'Código de Defesa do Consumidor (Lei nº 8.078/1990)', descricao: 'Proteção e defesa do consumidor.', url: 'https://www.planalto.gov.br/ccivil_03/leis/l8078compilado.htm' },
  { categoria: 'Legislação Trabalhista', titulo: 'Consolidação das Leis do Trabalho - CLT (Decreto-Lei nº 5.452/1943)', descricao: 'Normas de direito do trabalho.', url: 'https://www.planalto.gov.br/ccivil_03/decreto-lei/del5452compilado.htm' },
  { categoria: 'Legislação Especial', titulo: 'Estatuto da Criança e do Adolescente (Lei nº 8.069/1990)', descricao: 'Proteção integral à criança e ao adolescente.', url: 'https://www.planalto.gov.br/ccivil_03/leis/l8069.htm' },
  { categoria: 'Legislação Especial', titulo: 'Lei de Execução Penal (Lei nº 7.210/1984)', descricao: 'Normas de execução penal.', url: 'https://www.planalto.gov.br/ccivil_03/leis/l7210.htm' },
  { categoria: 'Legislação Especial', titulo: 'Lei Maria da Penha (Lei nº 11.340/2006)', descricao: 'Coíbe a violência doméstica e familiar contra a mulher.', url: 'https://www.planalto.gov.br/ccivil_03/_ato2004-2006/2006/lei/l11340.htm' },
